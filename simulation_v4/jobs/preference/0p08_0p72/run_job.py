#!/usr/bin/env python3
"""Time/Energy Preference sweep (0.08 to 0.72) reproducing Fig. 11."""
...
from run_sweep import sweep_preference  # noqa: E402
from stochastic_mec import AlgorithmParams  # noqa: E402

# ==============================================================================
# CONFIGURATION
# ==============================================================================
XS = [0.08, 0.16, 0.24, 0.32, 0.40, 0.48, 0.56, 0.64, 0.72]  # Time preference beta_n^t
...
def main() -> None:
    ...
    ap.add_argument(
        ...
        nargs="+",
        default=XS,
        help="Time preference beta_n^t values",
    )
    args = ap.parse_args()
