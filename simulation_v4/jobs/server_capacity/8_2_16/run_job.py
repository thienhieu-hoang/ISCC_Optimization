#!/usr/bin/env python3
"""Server Capacity sweep (8 to 16 GHz) reproducing Fig. 9."""
...
from run_sweep import sweep_capacity  # noqa: E402
from stochastic_mec import AlgorithmParams  # noqa: E402

# ==============================================================================
# CONFIGURATION
# ==============================================================================
XS = [8, 10, 12, 14, 16]           # Server capacity: [8, 10, 12, 14, 16] in GHz
...
def main() -> None:
    ...
    ap.add_argument(
        ...
        nargs="+",
        default=XS,
        help="Server capacity values in GHz",
    )
    args = ap.parse_args()
