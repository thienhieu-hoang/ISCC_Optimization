#!/usr/bin/env python3
"""Jammer Density sweep (0 to 4) reproducing Fig. 6b."""
...
from run_sweep import sweep_jammer_density  # noqa: E402
from stochastic_mec import AlgorithmParams  # noqa: E402

# ==============================================================================
# CONFIGURATION
# ==============================================================================
XS = list(range(0, 5))             # Jammer density: [0, 1, 2, 3, 4] in 1e-6/m^2
...
def main() -> None:
    ...
    ap.add_argument(
        ...
        nargs="+",
        default=XS,
        help="Jammer density values in 1e-6/m^2",
    )
    args = ap.parse_args()
