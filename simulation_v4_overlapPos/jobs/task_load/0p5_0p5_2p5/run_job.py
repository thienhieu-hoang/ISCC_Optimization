#!/usr/bin/env python3
"""Task Load sweep (0.5 to 2.5 Gcycles) reproducing Fig. 8."""
...
from run_sweep import sweep_taskload  # noqa: E402
from stochastic_mec import AlgorithmParams  # noqa: E402

# ==============================================================================
# CONFIGURATION
# ==============================================================================
XS = [0.5, 1.0, 1.5, 2.0, 2.5]     # Task load: [0.5, 1.0, 1.5, 2.0, 2.5] in Gcycles
...
def main() -> None:
    ...
    ap.add_argument(
        ...
        nargs="+",
        default=XS,
        help="Task load values in Gcycles",
    )
    args = ap.parse_args()
